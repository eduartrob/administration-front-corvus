...
import { Download, Filter, ChevronDown, ChevronLeft, ChevronRight, AlertTriangle, Clock, Calendar, Database } from 'lucide-react';
      ...
      <div className="p-8 h-full flex items-center justify-center">
        <div className="bg-surface-container-low border border-outline-variant/50 rounded-2xl p-16 flex flex-col items-center justify-center text-center max-w-2xl">
          ...
          <p className="text-body-lg text-on-surface-variant">
            Para validar tareas, primero debes seleccionar una universidad y su respectiva carrera en la barra superior.
          </p>
        </div>
      </div>
    );
